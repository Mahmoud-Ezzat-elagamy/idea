...
- **Static Analysis & Formatting**: Pint (`vendor/bin/pint`), PHPStan (`phpstan analyse`), Rector (`vendor/bin/rector`)
...
- **Blade**: Views reside in `resources/views`. Use standard Blade directives, Tailwind CSS v4, and Alpine.js for interactive UI components.
